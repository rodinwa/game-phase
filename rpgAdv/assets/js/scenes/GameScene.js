class GameScene extends Phaser.Scene {
    ...
    spawnMonster(monsterObject) {
        ...
        if (!monster) {
            ...
            // add the monster to the monsters group
    ...
    addCollisions() {
        ...
        // check for collisions between the monsters group and the tiled blocked layer
        this.physics.add.collider(this.monsters, this.map.blockedLayer);
        // check for operlaps between player's weapon and monster game objects
