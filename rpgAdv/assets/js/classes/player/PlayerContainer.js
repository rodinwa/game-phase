...
class PlayerContainer extends Phaser.GameObjects.Container {
    ...
    updateHealthBar() {
        ...
        // background for the bar (original: white)
        ...
        // // foreground (gradient from red -> white) based on current health
        // const width = Math.max(0, 64 * (this.health / this.maxHealth));
        // if (width > 0) {
        //     this.healthBar.fillGradientStyle(
        //         0xff0000, // top-left (red)
        //         0xffffff, // top-right (white)
        //         0xff0000, // bottom-left (red)
        //         0xffffff, // bottom-right (white)
        //         1, 1, 1, 1 // alphas
        //     );
        //     this.healthBar.fillRect(this.x - 32, this.y - 40, width, 5);
        // }
    }
